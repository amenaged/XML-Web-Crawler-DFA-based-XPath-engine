...
public class SubscribeChannelServlet extends HttpServlet {

	private static final long serialVersionUID = -679554691482623875L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		ServletHelper.WriteHeader(pw, "Subscribe Channel");
		if (username == null) {
			pw.print("<p>Please log in first to subscribe channels.</p>");
			...
			if (channel == null) {
				...
				if (user == null) {
					...
					pw.print("<p>You have been successfully subscibe this channel.</p>");
